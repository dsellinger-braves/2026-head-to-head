      ...
      if (isBattersTab) {
        ...
        results.push({
          ...
          rostered: {
            ...
            value: rosValue,
            stats: rosStats,
            summaryStr: `${rosHr} HR, ${rosRbi} RBI, ${rosR} R, ${rosSb} SB, ${rosObp.toFixed(4).replace(/^0/, '')} OBP`,
          },
          unrostered: {
            games: unrosGames,
            volume: unrosPa,
            ...
            value: unrosValue,
            stats: unrosStats,
            summaryStr: `${unrosHr} HR, ${unrosRbi} RBI, ${unrosR} R, ${unrosSb} SB, ${unrosObp > 0 ? unrosObp.toFixed(4).replace(/^0/, '') : '.0000'} OBP`,
          },
          disparity,
          keyCountingDiff: {
            statName: 'HR',
